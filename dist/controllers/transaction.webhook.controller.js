...
exports.pagarmeWebhook = void 0;
const crypto_1 = __importDefault(require("crypto"));
const transaction_model_1 = require("../models/transaction.model");
const transactionAudit_service_1 = require("../services/transactionAudit.service");
...
const pagarmeWebhook = async (req, res) => {
    try {
        ...
        if (secret && signature) {
            const expected = `sha1=${crypto_1.default
        ...
        if (oldStatus !== newStatus) {
            ...
            await transactionAudit_service_1.TransactionAuditService.log({
                transactionId: new mongoose_1.Types.ObjectId(String(transaction._id)),
                sellerId: new mongoose_1.Types.ObjectId(String(transaction.sellerId)),
                userId: new mongoose_1.Types.ObjectId(String(transaction.userId || transaction.sellerId)),
            ...
            console.log(`✅ [Webhook Pagar.me v5] Transação ${transactionId} atualizada: ${oldStatus} → ${newStatus}`);
        }
        else {
...
exports.pagarmeWebhook = pagarmeWebhook;
/* -------------------------------------------------------------------------- */
