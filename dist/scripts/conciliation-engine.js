...
(async () => {
    ...
    const bankFeed = [
        { ref: "PIX_OUT_001", amount: 1000, type: "debit" },
        { ref: "PIX_IN_002", amount: 1000, type: "credit" },
    ];
    const acquirerFeed = [
    ...
    const bankBalance = bankFeed.reduce((acc, e) => acc + (e.type === "credit" ? e.amount : -e.amount), 0);
    ...
    await ledgerSnapshot_model_1.default.updateMany({ dateKey: dateStr }, { $set: { locked, divergence } });
